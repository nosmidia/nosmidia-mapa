...
class Project_Upload {
    ...
    function __construct($file, $lang = 'en_GB') {
		...
		if ($this->lang == 'pt_Br') {
        	$translation = array();
		    $translation['file_error']                  = 'Erro de transmissÃ£o. Favor tentar novamente.';
		    $translation['local_file_missing']          = 'O arquivo local nÃ£o existe.';
		    $translation['local_file_not_readable']     = 'NÃ£o foi possÃ­vel ler o arquivo local.';
		    ...
		    $translation['uploaded_partial']            = 'Erro ao carregar o arquivo (o arquivo sÃ³ foi carregado parcialmente).';
		    $translation['uploaded_missing']            = 'Erro ao carregar o arquivo (o arquivo nÃ£o foi carregado).';
		    $translation['uploaded_unknown']            = 'Erro ao carregar o arquivo (cÃ³digo de erro desconhecido).';
		    $translation['try_again']                   = 'Erro ao carregar o arquivo. Favor tentar novamente.';
		    $translation['file_too_big']                = 'Arquivo muito grande.';
		    $translation['no_mime']                     = 'MIME type nÃ£o detectado.';
		    $translation['incorrect_file']              = 'Tipo de arquivo incorreto.';
		    $translation['image_too_wide']              = 'A imagem Ã© muito larga.';
		    $translation['image_too_narrow']            = 'A imagem Ã© muito estreita.';
		    $translation['image_too_high']              = 'A imagem Ã© muito alta.';
		    $translation['image_too_short']             = 'A imagem Ã© muito curto.';
		    $translation['ratio_too_high']              = 'O ratio Ã© muito alto (Imagem muito larga).';
		    $translation['ratio_too_low']               = 'O ratio Ã© muito baixo (Imagem muito alta).';
		    $translation['too_many_pixels']             = 'A imagem tem muitos pixels.';
		    $translation['not_enough_pixels']           = 'A imagem tem poucos pixels.';
		    $translation['file_not_uploaded']           = 'O arquivo nÃ£o foi transmitido. ImpossÃ­vel continuar.';
		    $translation['already_exists']              = '%s Ja existe. Favor mudar o nome do arquivo.';
		    $translation['temp_file_missing']           = 'O arquivo fonte Ã© incorreto. ImpossÃ­vel continuar.';
		    $translation['source_missing']              = 'O arquivo transmitido Ã© incorreto. ImpossÃ­vel continuar.';
		    $translation['destination_dir']             = 'O diretÃ³rio de destino nÃ£o pode ser criado. ImpossÃ­vel continuar.';
		    $translation['destination_dir_missing']     = 'O diretÃ³rio de destino nÃ£o existe. ImpossÃ­vel continuar.';
		    $translation['destination_path_not_dir']    = 'O path especificado nÃ£o Ã© um diretÃ³rio. ImpossÃ­vel continuar.';
		    $translation['destination_dir_write']       = 'Directorio de destino, sem permissÃ£o para editar. ImpossÃ­vel continuar.';
		    $translation['destination_path_write']      = 'O path de destino nÃ£o tem permissÃ£o de escrita ou nÃ£o pode ser aberto. ImpossÃ­vel continuar.';
		    $translation['temp_file']                   = 'NÃ£o foi possÃ­vel criar o arquivo temporÃ¡rio. ImpossÃ­vel continuar.';
		    $translation['source_not_readable']         = 'O arquivo fonte nÃ£o Ã© legÃ­vel. ImpossÃ­vel continuar.';
		    $translation['no_create_support']           = 'CriaÃ§Ã£o a partir do arquivo %s imposÃ­vel...';
		    $translation['create_error']                = 'Erro na criaÃ§Ã£o da imagem %s desde o cÃ³digo fonte.';
		    $translation['source_invalid']              = 'ImpossÃ­vel ler a imagem fonte. Ã‰ uma imagem?.';
		    $translation['gd_missing']                  = 'GD nÃ£o parece estar presente.';
		    $translation['watermark_no_create_support'] = 'CriaÃ§Ã£o a partir do arquivo %s impossÃ­vel, watermark nÃ£o pode ser lido.';
		    $translation['watermark_create_error']      = 'Erro no momento da criaÃ§Ã£o do watermark %s desde o arquivo fonte.';
		    $translation['watermark_invalid']           = 'ImpossÃ­vel ler o watermark, formato de arquivo desconhecido.';
		    $translation['file_create']                 = 'CriaÃ§Ã£o do arquivo %s impossÃ­vel.';
		    $translation['no_conversion_type']          = 'Tipo de conversÃ£o nÃ£o foi definida.';
        ...
        }else if ($this->lang != 'en_GB' && file_exists(dirname(__FILE__).'/lang') && file_exists(dirname(__FILE__).'/lang/class.upload.' . $lang . '.php')) {
            $translation = null;
