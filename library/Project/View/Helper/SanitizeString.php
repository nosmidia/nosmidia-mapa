<?php
/**
 * Helper de tirar caracteres especiais de uma string
 * Téstê de Sânitize => teste-de-sanitize
 *
 ...
 *
 */
class Project_View_Helper_SanitizeString
{
	public static function sanitizeString( $txt )
	{
		return self::sanitizeTitleWithDashes($txt);
	}
